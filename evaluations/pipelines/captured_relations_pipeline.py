...
def clean_data(data_file, verbose=False) -> dict():
    ...
    with open(data_file, "r") as f:
        data = json.load(f)
    for relation in data['Variables']:
...
if __name__ == "__main__":
    # # Prepare inputs:
    #print("Path: " + sys.path[0][:-21] + "inputs\\")
    data = clean_data(INPUTS_SOURCE + "Rejectionsensitivityprospectivelypredicts_10.1016j.brat.2011.06.004.json")
